...
void powerDistribution(const control_t *control)
{
    ...
    motorPower.m2 = limitThrust(control->thrust + control->pitch -
                               control->yaw);
    motorPower.m1 = limitThrust(control->thrust - control->roll +
                               control->yaw);
    motorPower.m4 =  limitThrust(control->thrust - control->pitch -
                               control->yaw);
    motorPower.m3 =  limitThrust(control->thrust + control->roll +
                               control->yaw);
  #endif
